function read(e,t,s){
    ...
    },n.open("GET",sheetsuUrlGet(e + "?callback=googleDocCallback",t),!0),n.send()
}
function readWithPromise(e,t){
    return new Promise(function(s,n){
        ...
        r.onload=function(){
            this.status>=200&&this.status<300?s(JSON.parse(r.responseText)):n({status:this.status,statusText:r.statusText})
        },
        r.setRequestHeader("Accept","application/vnd.sheetsu.3+json"),
        r.setRequestHeader("Content-Type","application/json"),
        r.setRequestHeader("X-User-Agent","Sheetsu-JS"),
        r.onerror=function(e){n(e)},r.send()
    })
}
...
function writeWithPromise(e,t,s){
    return new Promise(
        function(n,r){
            ...
            o.open("POST",sheetsuUrlPost(e,s),!0),
            o.onload=function(){
                this.status>=200&&this.status<300?n(JSON.parse(o.responseText)):r({status:this.status,statusText:o.statusText})
            },
            o.setRequestHeader("Accept","application/vnd.sheetsu.3+json"),
            o.setRequestHeader("Content-Type","application/json; charset=UTF-8"),
            o.setRequestHeader("X-User-Agent","Sheetsu-JS"),
            o.onerror=function(e){r(e)},
            o.send(JSON.stringify(t))
        }
    )
}
Sheetsu={
    ...
    write:function(){return 3==arguments.length?writeWithPromise.apply(null,arguments):write.apply(null,arguments)},
    version:"1.0"
};
